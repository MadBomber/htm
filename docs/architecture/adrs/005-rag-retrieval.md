...
**Impact**: Flexible retrieval with excellent recall and precision, at the cost of strategy selection complexity and embedding generation latency.
...
- [ADR-003: Ollama Embeddings](003-ollama-embeddings.md)
