...
class HTM
  ...
  class EmbeddingService
    ...
    # Embed method is deprecated - embeddings are now generated in the database
    #
    # @deprecated Use database triggers via pgai instead
    # @raise [HTM::EmbeddingError] Always raises error
    #
    def embed(_text)
      raise HTM::EmbeddingError, <<~ERROR
        Direct embedding generation is deprecated in HTM.

        Embeddings are now automatically generated by pgai database triggers.
        Simply insert nodes into the database and pgai will generate embeddings automatically.

        If you need to regenerate embeddings, UPDATE the node's value column.
      ERROR
    end
