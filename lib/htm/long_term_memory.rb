...
class HTM
  ...
  class LongTermMemory
    ...
    #
    # Embeddings are automatically generated by pgai database triggers.
    # No need to pass embedding parameter - it will be generated from the value.
    #
    ...
    # @param embedding [Array<Float>, nil] DEPRECATED - Vector embedding (auto-generated by pgai)
    ...
    def add(key:, value:, type: nil, category: nil, importance: 1.0, token_count: 0, robot_id:, embedding: nil)
      # Warn if embedding is provided (deprecated usage)
      if embedding
        warn "WARNING: Passing embedding parameter is deprecated. Embeddings are now auto-generated by pgai triggers."
      end

      # Insert node - pgai trigger will automatically generate embedding
